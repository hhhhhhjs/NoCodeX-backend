package com.example.aibyhhhhhhjs.service.impl;
...
import com.example.aibyhhhhhhjs.mapper.UserMapper;
...
import static com.example.aibyhhhhhhjs.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        if (userAccount.length() < 4) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "账号长度过短,必须大于等于4位");
        }
        if (userPassword.length() < 8 || checkPassword.length() < 8) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "密码长度过短,必须大于等于8位");
        }
